...
- (void)setupKeyBoard {
    ...
    NSInteger leftSpace = CGFloatIn1536(24);
    NSInteger topSpace = CGFloatIn1536(14);
    
    CGFloat numBtnHeiht = CGFloatIn1536(113);
    CGFloat numBtnWidth = CGFloatIn1536(174);
    
    CGFloat addBtnWidth = CGFloatIn1536(570);
    CGFloat addBtnHeight = CGFloatIn1536(110);
    
    CGFloat bottomBtnWidth = CGFloatIn1536(274);
    CGFloat bottomBtnHeight = CGFloatIn1536(110);
    
    CGFloat tempX = CGFloatIn1536(28);
    CGFloat tempY = CGFloatIn1536(14);

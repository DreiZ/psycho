...
//    [self.parameterDic removeAllObjects];
    ...
    if ([ZPublicManager shareInstance].isLogin) {
//        HNUser *user = [ZPublicManager shareInstance].user;
//        [parameterDic setObject:user.userID forKey:@"user_id"];
//        [parameterDic setObject:user.token forKey:@"token"];
    }
